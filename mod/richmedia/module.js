...
M.mod_richmedia = {
    ...
    initThemeManager: function() {
        ...
        function renderDel(value, metaData, record, rowIndex, colIndex, store) {
            var ret = '<img src = "' + M.cfg.wwwroot + '/mod/richmedia/pix/cross.png" alt = "suppr" onclick="M.mod_richmedia.deleteRow(' + record.data.id + ');"/><img src = "' + M.cfg.wwwroot + ' /mod/richmedia/pix/image_add.png" alt = "edit" onclick="M.mod_richmedia.editRow(' + record.data.id + ');"/>';
            return ret;
        }
