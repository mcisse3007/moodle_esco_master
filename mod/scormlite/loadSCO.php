...
if ($sco->popup == 0) $backhtml = '<input type="button" value="'.get_string('continue').'" onClick="top.location.href=\''.$backurl.'\'"/>';
else $backhtml = '<input type="button" value="'.get_string('continue').'" onClick="window.opener.location.href=\''.$backurl.'\';window.close();"/>';
