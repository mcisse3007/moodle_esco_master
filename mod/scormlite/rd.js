...
function scormlite_get_element_style(obj, prop, cssProp) {
    var ret = '';
...
function scormlite_resize (cwidth, cheight) {
    ...
    if (footer) {
        footerheight = footer.offsetHeight + parseInt(scormlite_get_element_style(footer, 'marginTop', 'margin-top')) + parseInt(scormlite_get_element_style(footer, 'marginBottom', 'margin-bottom'));
    }
    if (imsnavbar) {
    ...
    var topmargin = parseInt(scormlite_get_element_style(document.getElementsByTagName('body')[0], 'marginTop', 'margin-top'));
    var bottommargin = parseInt(scormlite_get_element_style(document.getElementsByTagName('body')[0], 'marginBottom', 'margin-bottom'));
