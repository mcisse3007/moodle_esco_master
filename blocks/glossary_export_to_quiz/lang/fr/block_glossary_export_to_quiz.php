...
Réponse courte
    ...
    * Insensible à la casse. On acceptera comme correcte toute réponse de l\'élève sans tenir compte de la casse (majuscules/minuscules).
          o Exemple: concept du glossaire "Moodle". Réponses acceptées comme correctes: "Moodle", "moodle".
    * Sensible à la casse. On acceptera comme correcte uniquement la réponse de l\'élève tenant compte de la casse (majuscules/minuscules) originale.
