...
/**
 * Strings for component 'block_course_overview_esco', language 'fr', branch 'MOODLE_25_STABLE'
 *
...
$string['course_overview_esco:addinstance'] = 'Ajouter un bloc de vue d\'ensemble de cours';
$string['course_overview_esco:myaddinstance'] = 'Ajouter un bloc vue d\'ensemble des cours à Ma page';
...
$string['pluginname'] = 'Vue d\'ensemble de mes cours';
$string['preservestates'] = 'Préserver les états replié/déplié';
$string['roleAll'] = 'Tous';
$string['roleOwner'] = 'Propriétaire';
$string['roleStudent'] = 'Élève';
$string['roleTeacher'] = 'Enseignant';
$string['roleType'] = 'Où j\'ai le rôle';
$string['sortbydateasc'] = 'Tri croissant par Date de création du cours';
$string['sortbydatedesc'] = 'Tri décroissant par Date de création du cours';
$string['sortbyfullnameasc'] = 'Tri croissant par Nom complet du cours';
$string['sortbyfullnamedesc'] = 'Tri décroissant par Nom complet du cours';
...
$string['showcategoriesdesc'] = 'Ce réglage détermine si les catégories de cours seront afficher au-dessous de chaque cours.';
...
$string['summaryhide'] = 'Cacher le résumé';
$string['summaryshow'] = 'Afficher le résumé';
$string['teachershide'] = 'Cacher les enseignants';
$string['teachersshow'] = 'Afficher les enseignants';
