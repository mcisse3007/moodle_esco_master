...
/**
 * Lang strings for course_overview_esco block
 *
...
$string['course_overview_esco:addinstance'] = 'Add a new course overview esco block';
$string['course_overview_esco:myaddinstance'] = 'Add a new course overview esco block to My home';
$string['defaultmaxcourses'] = 'Default maximum courses';
$string['defaultmaxcoursesdesc'] = 'Maximum courses which should be displayed on course overview esco block, 0 will show all courses';
...
$string['pluginname'] = 'Course overview esco';
$string['preservestates'] = 'Preserve expanded states';
$string['roleAll'] = 'All';
$string['roleOwner'] = 'Owner';
$string['roleStudent'] = 'Student';
$string['roleTeacher'] = 'Teacher';
$string['roleType'] = 'Filter by profile';
$string['sortbydateasc'] = 'Sort by Course time created ascending';
$string['sortbydatedesc'] = 'Sort by Course time created descending';
$string['sortbyfullnameasc'] = 'Sort by Course full name ascending';
$string['sortbyfullnamedesc'] = 'Sort by Course full name descending';
...
$string['summaryhide'] = 'Hide summary';
$string['summaryshow'] = 'Show summary';
$string['teachershide'] = 'Hide teachers';
$string['teachersshow'] = 'Show teachers';
