...
/**
 * Move/order course functionality for course_overview_esco block.
 *
...
list($courses, $sitecourses, $coursecount) = block_course_overview_esco_get_sorted_courses();
...
block_course_overview_esco_update_myorder(array_values($neworder));
redirect(new moodle_url('/my/index.php'));
