...
YUI().use('node', function(Y){
    ...
    Y.on('click', handleClickSummary, '.block_mycourse_teacher .summary_reply.fold_reply');
    ...
    Y.on('click', handleClickTeachers, '.block_mycourse_teacher .teachers_reply.fold_reply');
});
</script>";
			return $this->content;
		}
