...
<div id="PageFooterLinks">
        <a id="PageFooterLinksCG37" title="Département d'Indre-et-loire" target="_blank" href="http://www.cg37.fr/">
                <?php
                echo html_writer::empty_tag('img', array('src'=>$OUTPUT->pix_url('cg37', 'theme'), 'class'=>'logoCG37', 'alt'=>'Département d\'Indre-et-Loire'));
                ?>
        </a>
