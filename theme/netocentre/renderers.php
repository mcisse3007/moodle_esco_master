...
class theme_netocentre_core_renderer extends core_renderer {
    ...
    public function block(block_contents $bc, $region) {
        ...
        /** Header **/        
        $output .= html_writer::start_tag('div', array('class'=>'header_block'));

        $output .= html_writer::start_tag('div', array('class'=>'i1'));
        $output .= html_writer::start_tag('div', array('class'=>'i2'));
        $output .= html_writer::start_tag('div', array('class'=>'i3'));
