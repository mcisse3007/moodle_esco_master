...
<?php
// Ajouts pour placer les logos des partenaires du projet en bas de page
?>
<div id="PageFooterLinks">
	<a id="PageFooterLinksRegion" title="Région Centre" target="_blank" href="http://www.regioncentre.fr/">
		<?php
		echo html_writer::empty_tag('img', array('src'=>$OUTPUT->pix_url('region-centre', 'theme'), 'class'=>'logoRegion', 'alt'=>'Région Centre-Val de Loire'));
		?>
	</a>
	<a id="PageFooterLinksEN" title="Éducation Nationale - Académie Orléans-Tours" target="_blank" href="http://www.ac-orleans-tours.fr">
		<?php
		echo html_writer::empty_tag('img', array('src'=>$OUTPUT->pix_url('education-nationale', 'theme'), 'class'=>'logoEN', 'alt'=>'Éducation Nationale - Académie Orléans-Tours'));
		?>
	</a>
	<a id="PageFooterLinksEA" title="Enseignement Agricole en Région Centre" target="_blank" href="http://draaf.centre.agriculture.gouv.fr/">
		<?php
		echo html_writer::empty_tag('img', array('src'=>$OUTPUT->pix_url('enseignement-agricole', 'theme'), 'class'=>'logoAgri', 'alt'=>'Enseignement Agricole en Région Centre-Val de Loire'));
		?>
	</a>
	<a id="PageFooterLinksEtat" title="Préfecture de la Région Centre" target="_blank" href="http://www.centre.pref.gouv.fr/">
		<?php
		echo html_writer::empty_tag('img', array('src'=>$OUTPUT->pix_url('republique-francaise', 'theme'), 'class'=>'logoPref', 'alt'=>'Préfecture de la Région Centre-Val de Loire'));
		?>
	</a>
	<a id="PageFooterLinksEurope" title="Union Européenne" target="_blank" href="http://europa.eu/index_fr.htm">
		<?php
		echo html_writer::empty_tag('img', array('src'=>$OUTPUT->pix_url('europe', 'theme'), 'class'=>'logoEurope', 'alt'=>'Union Européenne'));
		?>
	</a>
</div>
