...
com.wiris.quizzes.JsComponent.prototype = {
	...
	,getOwnerWindow: function() {
		...
		var win = null;
		if('defaultView' in doc) win = doc.defaultView; else if('parentWindow' in doc) win = doc.parentWindow;
		return win;
	}
	,getLang: function() {
		if(com.wiris.quizzes.JsComponent.lang == null) {
			com.wiris.quizzes.JsComponent.lang = "en";
			var elements = com.wiris.quizzes.JsDomUtils.getElementsByClassName("wirislang","input");
			if(elements.length > 0) {
				var elem = elements[0];
				com.wiris.quizzes.JsComponent.lang = elem.value;
			}
			var hypen = com.wiris.quizzes.JsComponent.lang.indexOf("-");
			if(hypen != -1) com.wiris.quizzes.JsComponent.lang = HxOverrides.substr(com.wiris.quizzes.JsComponent.lang,0,hypen);
			hypen = com.wiris.quizzes.JsComponent.lang.indexOf("_");
			if(hypen != -1) com.wiris.quizzes.JsComponent.lang = HxOverrides.substr(com.wiris.quizzes.JsComponent.lang,0,hypen);
		}
...
com.wiris.quizzes.JsPopupInput.prototype = $extend(com.wiris.quizzes.JsInput.prototype,{
	...
	,newPopup: function() {
		...
		this.popup = currentWindow.open("",this.popupName,"status=no,toolbar=no,location=no,menubar=no,directories=no,scrollbars=no,resizable=no,width=" + this.popupWidth + ",height=" + this.popupHeight);
		...
		com.wiris.quizzes.JsDomUtils.addEvent(this.popup,"unload",function() {
			_g.popup = null;
		});
	}
...
com.wiris.quizzes.JsSubmitButtons = $hxClasses["com.wiris.quizzes.JsSubmitButtons"] = function(d) {
	com.wiris.quizzes.JsComponent.call(this,d);
	this.element = d.createElement("div");
...
com.wiris.quizzes.JsSubmitButtons.prototype = $extend(com.wiris.quizzes.JsComponent.prototype,{
	...
	,setCancelHandler: function(f) {
		var _g = this;
		this.cancel.setOnClick(function(e) {
			f(e);
			_g.closePopup(e);
		});
	}
	,setAcceptHandler: function(f) {
		var _g = this;
		this.accept.setOnClick(function(e) {
			f(e);
			_g.closePopup(e);
		});
	}
...
com.wiris.quizzes.JsCasInput.prototype = $extend(com.wiris.quizzes.JsInput.prototype,{
	...
	,loadApplet: function() {
		...
		this.applet = d.createElement("applet");
		this.applet.setAttribute("codeBase",com.wiris.quizzes.impl.QuizzesBuilderImpl.getInstance().getConfiguration().get(com.wiris.quizzes.api.ConfigurationKeys.WIRIS_URL) + "/wiris-codebase");
		this.applet.setAttribute("code","WirisApplet_net_" + this.caslang);
		this.applet.setAttribute("archive","wrs_net_" + this.caslang + ".jar");
		this.applet.setAttribute("height","100%");
		this.applet.setAttribute("width","100%");
		var p = d.createElement("param");
		p.setAttribute("name","command");
		p.setAttribute("value","false");
		this.applet.appendChild(p);
		p = d.createElement("param");
		p.setAttribute("name","commands");
		p.setAttribute("value","false");
		this.applet.appendChild(p);
		p = d.createElement("param");
		p.setAttribute("name","interface");
		p.setAttribute("value","false");
		this.applet.appendChild(p);
		p = d.createElement("param");
		p.setAttribute("name","syncElementId");
		p.setAttribute("value",this.input.id);
		this.applet.appendChild(p);
		var old = this.appletWrapper.firstChild;
		if(old == null) this.appletWrapper.appendChild(this.applet); else this.appletWrapper.replaceChild(this.applet,old);
	}
...
com.wiris.quizzes.JsLabel = $hxClasses["com.wiris.quizzes.JsLabel"] = function(d,text,input) {
	...
	this.element.appendChild(d.createTextNode(this.t("algorithmlanguage")));
...
com.wiris.quizzes.JsEditorInput.prototype = $extend(com.wiris.quizzes.JsInput.prototype,{
	...
	,setParams: function(parameters) {
		...
		if(this.editor != null) this.editor.getEditorModel().setParams(parameters);
	}
	,updateReservedWords: function(grammarurl) {
		...
		http.onData = function(data) {
			...
			var mathml = h.updateReservedWords(_g.getValue(),data.split(","));
			_g.setValue(mathml);
		};
	}
	,getValue: function() {
		if(this.editor != null) this.value = this.editor.getMathML();
		return this.value;
	}
	,setValue: function(s) {
...
com.wiris.quizzes.JsStudentAnswerInput = $hxClasses["com.wiris.quizzes.JsStudentAnswerInput"] = function(d,v,type,fieldset,grammar) {
	com.wiris.quizzes.JsInput.call(this,d,v);
	this.type = type;
...
com.wiris.quizzes.JsStudentAnswerInput.prototype = $extend(com.wiris.quizzes.JsInput.prototype,{
	...
	,buildInput: function(d) {
		...
		case com.wiris.quizzes.JsStudentAnswerInput.TYPE_EDITOR:
			var params = { };
			params.toolbar = "quizzes";
			var editor = new com.wiris.quizzes.JsEditorInput(d,this.value,params);
			if(this.grammar != null) editor.setGrammarUrl(this.grammar);
			this.input = editor;
			break;
		...
		if(this.fieldset && this.type != com.wiris.quizzes.JsStudentAnswerInput.TYPE_EDITOR) {
			var f = new com.wiris.quizzes.JsFieldset(d,this.t("studentanswer"),true);
...
com.wiris.quizzes.JsStudioInput = $hxClasses["com.wiris.quizzes.JsStudioInput"] = function(d,v,q,qi,index,classes) {
	this.options = classes;
	this.htmlguiconf = new com.wiris.quizzes.impl.HTMLGuiConfig(this.options);
	this.index = index;
...
com.wiris.quizzes.JsStudioInput.prototype = $extend(com.wiris.quizzes.JsImageMathInput.prototype,{
	...
	,checkConfirmExit: function(studio) {
		...
		return function(e) {
			...
			if(qq.isEquivalent(studio.getQuestion())) return;
			var me = _g;
	...
	,buildPopup: function() {
		var _g = this;
		var container = new com.wiris.quizzes.JsContainer(this.popup.document);
		if(this.htmlguiconf.optOpenAnswer) {
		...
		var studio = new com.wiris.quizzes.JsStudio(this.popup.document,this.copyQuestion(),this.instance,this.index,this.options);
		container.addChild(studio);
		var submit = new com.wiris.quizzes.JsSubmitButtons(this.popup.document);
		submit.setAcceptHandler(function(e) {
			_g.confirmExit = true;
			_g.updateQuestion(studio.getQuestion());
			if(_g.htmlguiconf.optOpenAnswer) _g.setValue(studio.getCorrectAnswer());
			_g.updateSummaries();
		});
		...
		this.popup.onbeforeunload = this.checkConfirmExit(studio);
	}
	,buildMath: function(d) {
...
com.wiris.quizzes.JsAuthoringInput = $hxClasses["com.wiris.quizzes.JsAuthoringInput"] = function(d,v,q,qi,index,classes) {
	com.wiris.quizzes.JsInput.call(this,d,v);
	if(classes.indexOf("wirisstudio") != -1) {
		this.studio = new com.wiris.quizzes.JsStudioInput(d,v,q,qi,index,classes);
		this.input = this.studio;
		this.type = com.wiris.quizzes.JsAuthoringInput.TYPE_STUDIO;
	} else {
		var params = { };
		params.toolbar = "quizzes";
		this.input = new com.wiris.quizzes.JsEditorInput(d,v,params);
		this.type = com.wiris.quizzes.JsAuthoringInput.TYPE_EDITOR;
		this.question = q;
		this.instance = qi;
		this.index = index;
	}
...
com.wiris.quizzes.JsAuthoringInput.prototype = $extend(com.wiris.quizzes.JsInput.prototype,{
	getQuestion: function() {
		if(this.type == com.wiris.quizzes.JsAuthoringInput.TYPE_EDITOR) {
			var qq = this.question.getImpl();
			qq.setCorrectAnswer(this.index,this.getValue());
			return this.question;
		} else return this.studio.getQuestion();
	}
	,getValue: function() {
		this.value = this.input.getValue();
		return this.value;
...
com.wiris.quizzes.JsAnswerInput = $hxClasses["com.wiris.quizzes.JsAnswerInput"] = function(d,v,q,qi,index,classes) {
	com.wiris.quizzes.JsStudentAnswerInput.call(this,d,this.answerValue(v,q,qi),this.getStudentAnswerInputType(q),false,(js.Boot.__cast(q , com.wiris.quizzes.impl.QuestionInternal)).getImpl().getGrammarUrl(index));
...
com.wiris.quizzes.JsAuxiliarCasInput.prototype = $extend(com.wiris.quizzes.JsInput.prototype,{
	...
	,getQuestionInstance: function() {
		...
		ii.setLocalData(com.wiris.quizzes.impl.LocalData.KEY_CAS_SESSION,this.getValue());
...
com.wiris.quizzes.JsVerticalTabs = $hxClasses["com.wiris.quizzes.JsVerticalTabs"] = function(d,start) {
	...
	com.wiris.quizzes.JsDomUtils.addClass(left,"wiristabsleftcolumn");
...
com.wiris.quizzes.JsVerticalTabs.prototype = $extend(com.wiris.quizzes.JsComponent.prototype,{
	...
	,addTab: function(title,component,help) {
		...
		com.wiris.quizzes.JsDomUtils.addEvent(a,"click",function() {
			_g.setActive(index);
		});
		this.length++;
	}
...
com.wiris.quizzes.JsAnswerFeedback = $hxClasses["com.wiris.quizzes.JsAnswerFeedback"] = function(d,q,qi,index,classes) {
	com.wiris.quizzes.JsComponent.call(this,d);
...
com.wiris.quizzes.JsDomUtils.addClass = function(element,className) {
	if(!com.wiris.quizzes.JsDomUtils.hasClass(element,className)) {
		if(element.className == null || element.className.length == 0) element.className = className; else element.className = element.className + " " + className;
	}
}
...
com.wiris.quizzes.JsEditorInterface = $hxClasses["com.wiris.quizzes.JsEditorInterface"] = function() { }
com.wiris.quizzes.JsEditorInterface.__name__ = ["com","wiris","quizzes","JsEditorInterface"];
com.wiris.quizzes.JsEditorInterface.prototype = {
	insertInto: null
	,getEditorModel: null
	,getElement: null
	,isReady: null
	,setMathML: null
	,getMathML: null
	,__class__: com.wiris.quizzes.JsEditorInterface
}
com.wiris.quizzes.JsEditorListener = $hxClasses["com.wiris.quizzes.JsEditorListener"] = function(element,controller) {
	this.controller = controller;
	this.element = element;
};
com.wiris.quizzes.JsEditorListener.__name__ = ["com","wiris","quizzes","JsEditorListener"];
com.wiris.quizzes.JsEditorListener.prototype = {
	mathmlSetted: function(source) {
	}
	...
	,element: null
	,controller: null
	,__class__: com.wiris.quizzes.JsEditorListener
}
com.wiris.quizzes.JsEditorModelInterface = $hxClasses["com.wiris.quizzes.JsEditorModelInterface"] = function() { }
com.wiris.quizzes.JsEditorModelInterface.__name__ = ["com","wiris","quizzes","JsEditorModelInterface"];
com.wiris.quizzes.JsEditorModelInterface.prototype = {
	setParams: null
	,addEditorListener: null
	,setMathML: null
	,getMathML: null
	,__class__: com.wiris.quizzes.JsEditorModelInterface
}
...
com.wiris.quizzes.JsInputController.prototype = {
	setBehavior: function() {
		...
		if(name == "input" && (type == "text" || type == "hidden" || type == "radio" || type == "checkbox") || name == "textarea" || name == "select") com.wiris.quizzes.JsDomUtils.addEvent(this.element,"change",$bind(this,this.updateInputValue)); else if(name == "applet") com.wiris.quizzes.JsDomUtils.addEvent(this.element,"blur",$bind(this,this.updateInputValue)); else if(name == "a" || name == "input" && type == "button" || name == "button") com.wiris.quizzes.JsDomUtils.addEvent(this.element,"click",$bind(this,this.updateInputValue)); else if(com.wiris.quizzes.JsInputController.DEBUG) throw "Unsupported element " + name + ".";
	}
...
com.wiris.quizzes.JsQuizzesFilter.main = function() {
	if(js.Lib.document.readyState == "complete") com.wiris.quizzes.JsQuizzesFilter.init(); else com.wiris.quizzes.JsDomUtils.addEvent(js.Lib.window,"load",com.wiris.quizzes.JsQuizzesFilter.init);
...
com.wiris.quizzes.JsQuizzesFilter.prototype = {
	...
	,filterAnswerFeedback: function(element,index,question,instance,options) {
		...
		if(ii.hasEvaluation()) {
			var doc = element.ownerDocument;
			var component = new com.wiris.quizzes.JsAnswerFeedback(doc,question,instance,index,options);
			element.parentNode.insertBefore(component.element,element);
		}
	}
	,filterAuxiliarCasApplet: function(element,index,question,instance,options) {
		var qq = question.getImpl();
		if(qq.getLocalData(com.wiris.quizzes.impl.LocalData.KEY_SHOW_CAS) != com.wiris.quizzes.impl.LocalData.VALUE_SHOW_CAS_FALSE) {
			var ii = instance;
			var doc = element.ownerDocument;
			...
			element.parentNode.insertBefore(component.element,element);
			if(element.form != null) com.wiris.quizzes.JsDomUtils.addEvent(element.form,"submit",function() {
				element.value = component.getValue();
				instance = component.getQuestionInstance();
			});
		}
	}
	,filterAnswerField: function(element,index,question,instance,options) {
		var ii = instance;
		ii.userData.setUserAnswer(index,element.value);
		var doc = element.ownerDocument;
		var component = new com.wiris.quizzes.JsAnswerInput(doc,element.value,question,instance,index,options);
		element.parentNode.insertBefore(component.element,element);
		if(element.form != null) com.wiris.quizzes.JsDomUtils.addEvent(element.form,"submit",function() {
			element.value = component.getValue();
		});
	}
	,filterAuthoringField: function(element,index,question,instance,options) {
		var qq = question.getImpl();
		qq.setCorrectAnswer(index,element.value);
		var doc = element.ownerDocument;
		var component = new com.wiris.quizzes.JsAuthoringInput(doc,element.value,question,instance,index,options);
		element.parentNode.insertBefore(component.element,element);
		if(element.form != null) com.wiris.quizzes.JsDomUtils.addEvent(element.form,"submit",function() {
			element.value = component.getValue();
	...
	,filterFields: function(className) {
		...
		while(_g1 < _g) {
			...
			if(!com.wiris.quizzes.JsDomUtils.hasClass(element[0],"wirisprocessed")) {
				var questionElement = com.wiris.quizzes.JsDomUtils.getNearestElementByClassName(element[0],com.wiris.quizzes.JsQuizzesFilter.CLASS_QUESTION);
				var question = [this.getQuestionObject(questionElement)];
				var instanceElement = com.wiris.quizzes.JsDomUtils.getNearestElementByClassName(element[0],com.wiris.quizzes.JsQuizzesFilter.CLASS_QUESTION_INSTANCE);
				var instance = [this.getInstanceObject(instanceElement)];
				if(lastQuestionElement != questionElement) index = 0;
				lastQuestionElement = questionElement;
				switch(className) {
				case com.wiris.quizzes.JsQuizzesFilter.CLASS_AUTHOR_FIELD:
					this.filterAuthoringField(element[0],index,question[0],instance[0],element[0].className);
					break;
				case com.wiris.quizzes.JsQuizzesFilter.CLASS_ANSWER_FIELD:
					this.filterAnswerField(element[0],index,question[0],instance[0],element[0].className);
					break;
				case com.wiris.quizzes.JsQuizzesFilter.CLASS_AUXILIAR_CAS_APPLET:
					this.filterAuxiliarCasApplet(element[0],index,question[0],instance[0],element[0].className);
					break;
				case com.wiris.quizzes.JsQuizzesFilter.CLASS_ANSWER_FEEDBACK:
					this.filterAnswerFeedback(element[0],index,question[0],instance[0],element[0].className);
					break;
				case com.wiris.quizzes.JsQuizzesFilter.CLASS_QUESTION:
					if(element[0].form != null) com.wiris.quizzes.JsDomUtils.addEvent(element[0].form,"submit",(function(question,element) {
						return function() {
							element[0].value = question[0].serialize();
						};
					})(question,element));
					break;
				case com.wiris.quizzes.JsQuizzesFilter.CLASS_QUESTION_INSTANCE:
					if(element[0].form != null) com.wiris.quizzes.JsDomUtils.addEvent(element[0].form,"submit",(function(instance,element) {
						return function() {
							element[0].value = instance[0].serialize();
						};
					})(instance,element));
					break;
				}
				element[0].style.display = "none";
				com.wiris.quizzes.JsDomUtils.addClass(element[0],"wirisprocessed");
				index++;
			}
		}
	}
...
com.wiris.quizzes.JsStudio = $hxClasses["com.wiris.quizzes.JsStudio"] = function(d,q,qi,index,options) {
	com.wiris.quizzes.JsComponent.call(this,d);
	this.ready = false;
	this.controllers = new Array();
	this.question = q;
	this.instance = qi;
	this.htmlguiconf = new com.wiris.quizzes.impl.HTMLGuiConfig(options);
	this.htmlgui = new com.wiris.quizzes.impl.HTMLGui(this.getLang());
	...
	if(this.htmlguiconf.tabCorrectAnswer) {
		...
		content.element.innerHTML = this.htmlgui.getTabCorrectAnswer((js.Boot.__cast(q , com.wiris.quizzes.impl.QuestionInternal)).getImpl(),index,0,this.htmlguiconf);
		this.tabs.addTab(this.t("correctanswer"),content,this.t("correctanswertabhelp"));
	}
	if(this.htmlguiconf.tabValidation) {
		var content = new com.wiris.quizzes.JsContainer(d);
		content.element.innerHTML = this.htmlgui.getTabValidation((js.Boot.__cast(q , com.wiris.quizzes.impl.QuestionInternal)).getImpl(),index,0,this.htmlguiconf);
		this.tabs.addTab(this.t("validation"),content,this.t("assertionstabhelp"));
	}
	if(this.htmlguiconf.tabVariables) {
		var content = new com.wiris.quizzes.JsContainer(d);
		content.element.innerHTML = this.htmlgui.getTabVariables((js.Boot.__cast(q , com.wiris.quizzes.impl.QuestionInternal)).getImpl(),index,0,this.htmlguiconf);
		this.tabs.addTab(this.t("variables"),content,this.t("variablestabhelp"));
	}
	if(this.htmlguiconf.tabPreview) {
		var content = new com.wiris.quizzes.JsContainer(d);
		content.element.innerHTML = this.htmlgui.getTabPreview((js.Boot.__cast(q , com.wiris.quizzes.impl.QuestionInternal)).getImpl(),qi,index,0,this.htmlguiconf);
...
com.wiris.quizzes.JsStudio.prototype = $extend(com.wiris.quizzes.JsComponent.prototype,{
	addBehaviors: function(element,question,instance) {
		...
		while(_g < n) {
			...
			if(id == "wiriscas") {
				...
				controller[0].updateInterface = (function(controller,elem) {
					return function(value) {
						if(com.wiris.quizzes.JsDomUtils.hasClass(elem[0],"wirisjscomponent")) {
							var params = { };
							params.toolbar = "quizzes";
							_g1.correctAnswer = new com.wiris.quizzes.JsEditorInput(elem[0].ownerDocument,value,params);
							_g1.correctAnswer.setGrammarUrl(question.getGrammarUrl(0),false);
							elem[0].parentNode.replaceChild(_g1.correctAnswer.element,elem[0]);
					...
					return function(value) {
						...
						if(paramName[0] == "listoperators") {
							...
							while(_g2 < names.length) {
								...
								++_g2;
								var index = question.getAssertionIndex(assertionName,correctAnswer[0],userAnswer[0]);
								if(index != -1) question.assertions[index].setParam("groupoperators",groupvalue);
							}
						}
					};
				...
				var correctAnswer = [Std.parseInt(this.getIndex(elem[0].id,3))];
				var userAnswer = [Std.parseInt(this.getIndex(elem[0].id,4))];
				controller[0].setQuestionValue = (function(userAnswer,correctAnswer,paramName,assertionName,elem) {
					return function(value) {
						var index = question.getAssertionIndex(assertionName[0],correctAnswer[0],userAnswer[0]);
						if(index != -1) {
							if(assertionName[0] == "equivalent_function") {
								if(StringTools.startsWith(value,"#")) {
									value = HxOverrides.substr(value,1,null);
									elem[0].value = value;
								}
							}
							question.assertions[index].setParam(paramName[0],value);
						}
					};
				})(userAnswer,correctAnswer,paramName,assertionName,elem);
				...
				controller[0].updateInterface = (function(userAnswer,assertionName) {
					return function(value) {
						if(_g1.ready) {
							if(StringTools.startsWith(assertionName[0],"syntax_")) _g1.updateGrammar(userAnswer[0]);
						}
					};
				})(userAnswer,assertionName);
					...
					return function(value) {
						...
						if(boolValue) {
							...
							while(_g11 < singletons[0].length) {
								...
								if(question.assertions != null && StringTools.startsWith(assertionName[0],prefix1)) {
									...
									while(k >= 0) {
										...
										if(StringTools.startsWith(assertion.name,prefix1) && assertion.getCorrectAnswer() == correctAnswer[0] && assertion.getAnswer() == userAnswer[0]) HxOverrides.remove(question.assertions,assertion);
										k--;
									}
								}
							}
							...
							while(_g2 < _g3.length) {
								var cont = _g3[_g2];
								++_g2;
								if(StringTools.startsWith(_g1.getMainId(cont.element.id),"wirisassertionparam")) cont.saveInputValue();
							}
						} else {
							var index = question.getAssertionIndex(assertionName[0],correctAnswer[0],userAnswer[0]);
				...
				controller[0].updateInterface = (function(userAnswer,correctAnswer,assertionName,elem) {
					return function(value) {
						var boolValue = value.toLowerCase() == "true";
						if(boolValue && StringTools.startsWith(assertionName[0],"syntax_")) {
							...
							if(assertionName[0] == "syntax_expression") {
								...
								visibleDivs = ["wirissyntaxconstants","wirissyntaxfunctions","wirissyntaxcurlybracket"];
							} else if(assertionName[0] == "syntax_quantity") {
								legend = _g1.t("syntaxparams_quantity");
								visibleDivs = ["wirissyntaxconstants","wirissyntaxunits","wirissyntaxunitprefixes","wirissyntaxmixedfractions","wirissyntaxcurlybracket"];
							} else if(assertionName[0] == "syntax_list") {
								legend = _g1.t("syntaxparams_list");
								visibleDivs = ["wirissyntaxconstants","wirissyntaxfunctions"];
							}
							var allDivs = ["wirissyntaxconstants","wirissyntaxfunctions","wirissyntaxunits","wirissyntaxunitprefixes","wirissyntaxcurlybracket","wirissyntaxmixedfractions"];
							...
							var paramid = "wirisassertionparam" + unique + "[equivalent_function][name][" + correctAnswer[0] + "][" + userAnswer[0] + "]";
							var finput = elem[0].ownerDocument.getElementById(paramid);
							var equivFunction = assertionName[0] == "equivalent_function";
							finput.disabled = !equivFunction;
							if(question.getLocalData(com.wiris.quizzes.impl.LocalData.KEY_OPENANSWER_COMPOUND_ANSWER) == com.wiris.quizzes.impl.LocalData.VALUE_OPENANSWER_COMPOUND_ANSWER_TRUE) {
								var distribute = elem[0].ownerDocument.getElementById("wirislocaldata" + unique + "[gradeCompound][distribute]");
								if(equivFunction && distribute.checked) {
									distribute.checked = false;
									var and = elem[0].ownerDocument.getElementById("wirislocaldata" + unique + "[gradeCompound][and]");
									and.checked = true;
									var dist = elem[0].ownerDocument.getElementById("wirislocaldata" + unique + "[gradeCompoundDistribution]");
									dist.value = "";
									dist.disabled = true;
								}
				...
				})(userAnswer,correctAnswer,assertionName,elem);
				...
				controller[0].updateInterface = (function(index,controller,elem) {
					return function(value) {
						if(com.wiris.quizzes.JsDomUtils.hasClass(elem[0],"wirisjscomponent")) {
							...
							_g1.testAnswer = new com.wiris.quizzes.JsStudentAnswerInput(doc,value,type,doc != js.Lib.document,question.getGrammarUrl(index[0]));
							elem[0].parentNode.replaceChild(_g1.testAnswer.element,elem[0]);
				...
				return function(value) {
					...
					var content = question.correctAnswers[caIndex].content;
					if(_g1.testAnswer.isText() && !_g1.testAnswer.isCompound()) {
						var tools = new com.wiris.quizzes.impl.HTMLTools();
						content = tools.mathMLToText(content);
						content = instance.expandVariablesText(content);
					} else content = instance.expandVariables(content);
	...
	,updateGrammar: function(userAnswer) {
		...
		if(this.correctAnswer != null) {
			var f = function() {
				_g.correctAnswer.setGrammarUrl(q.getGrammarUrl(userAnswer),false);
			};
			win.setTimeout(f,0);
		}
	}
	...
	,init: function() {
		...
		this.tabs.init();
		if(!this.htmlguiconf.optOpenAnswer && this.htmlguiconf.optAuxiliarCas && this.htmlguiconf.tabVariables) this.tabs.setActive(1); else this.tabs.setActive(0);
...
com.wiris.quizzes.api.QuizzesBuilder.getInstance = function() {
	return com.wiris.quizzes.impl.QuizzesBuilderImpl.getInstance();
}
com.wiris.quizzes.api.QuizzesBuilder.prototype = {
	...
	,newEvalMultipleAnswersRequest: function(correctAnswers,studentAnswers,question,instance) {
		return null;
	}
...
com.wiris.quizzes.impl.Assertion.initParams = function() {
	...
	com.wiris.quizzes.impl.Assertion.paramnames.set("syntax_expression",["constants","functions"]);
	com.wiris.quizzes.impl.Assertion.paramnames.set("syntax_list",["constants","functions"]);
	com.wiris.quizzes.impl.Assertion.paramnames.set("syntax_quantity",["constants","units","unitprefixes","mixedfractions"]);
	...
	paramvalues.set("groupoperators",groupoperators);
	paramvalues.set("listoperators",listoperators);
	paramvalues.set("units","sr, m, g, s, E, K, mol, cd, rad, h, min, l, N, Pa, Hz, W,J, C, V, " + com.wiris.system.Utf8.uchr(937) + ", F, S, Wb, b, H, T, lx, lm, Gy, Bq, Sv, kat");
	paramvalues.set("unitprefixes","y, z, a, f, p, n, " + com.wiris.system.Utf8.uchr(181) + ", m, c, d, da, h, k, M, G, T, P, E, Z, Y");
...
com.wiris.quizzes.impl.Assertion.prototype = $extend(com.wiris.util.xml.SerializableImpl.prototype,{
	...
	,setParam: function(name,value) {
		...
		if(this.isDefaultParameterValue(name,value)) {
			...
			while(_g1 < _g) {
				var j1 = _g1++;
				if(this.parameters[j1].name == name) HxOverrides.remove(this.parameters,this.parameters[j1]);
			}
		} else {
			var found = false;
			var i;
...
com.wiris.quizzes.impl.AssertionCheck = $hxClasses["com.wiris.quizzes.impl.AssertionCheck"] = function() {
	com.wiris.util.xml.SerializableImpl.call(this);
};
com.wiris.quizzes.impl.AssertionCheck.__name__ = ["com","wiris","quizzes","impl","AssertionCheck"];
com.wiris.quizzes.impl.AssertionCheck.__super__ = com.wiris.util.xml.SerializableImpl;
com.wiris.quizzes.impl.AssertionCheck.prototype = $extend(com.wiris.util.xml.SerializableImpl.prototype,{
	getAnswers: function() {
		return this.answer;
	}
	,getAnswer: function() {
	...
	,newInstance: function() {
		return new com.wiris.quizzes.impl.AssertionCheck();
	}
	,onSerialize: function(s) {
		s.beginTag(com.wiris.quizzes.impl.AssertionCheck.tagName);
	...
	,assertion: null
	,value: null
	,__class__: com.wiris.quizzes.impl.AssertionCheck
});
...
com.wiris.quizzes.impl.ConfigurationImpl = $hxClasses["com.wiris.quizzes.impl.ConfigurationImpl"] = function() {
	...
	if(!com.wiris.settings.PlatformSettings.IS_JAVASCRIPT) {
		...
		if(!(className == "")) try {
			...
			var keys = [com.wiris.quizzes.api.ConfigurationKeys.WIRIS_URL,com.wiris.quizzes.api.ConfigurationKeys.EDITOR_URL,com.wiris.quizzes.api.ConfigurationKeys.SERVICE_URL,com.wiris.quizzes.api.ConfigurationKeys.PROXY_URL,com.wiris.quizzes.api.ConfigurationKeys.CACHE_DIR,com.wiris.quizzes.api.ConfigurationKeys.MAXCONNECTIONS];
			var i;
...
com.wiris.quizzes.impl.HTMLGui.prototype = {
	...
	,getWirisTestDynamic: function(q,qi,correctAnswer,unique) {
		...
		if(q.assertions != null && q.assertions.length > 0 && qi.hasEvaluation()) {
			...
			if(grade == 1.0) {
				...
				h.text(js.Boot.__cast(grade * 100 , Int) + "% ");
		...
		if(hasCorrectAnswer) {
			...
			if(com.wiris.quizzes.impl.MathContent.getMathType(content) == com.wiris.quizzes.impl.MathContent.TYPE_MATHML) this.printMathML(h,content); else h.text(content);
		}
		h.close();
		h.close();
		return h.getString();
	...
	,printAssertionsControls: function(h,q,correctAnswer,unique) {
				...
				if(index == a.getCorrectAnswer()) {
					...
					if(StringTools.startsWith(a.name,"syntax_")) {
						if(!(text == this.t.t(com.wiris.quizzes.impl.Assertion.SYNTAX_EXPRESSION))) {
							syntax = text;
							if(!StringTools.endsWith(syntax,".")) syntax = syntax + ".";
							showSyntax = true;
						}
					} else if(StringTools.startsWith(a.name,"equivalent_")) {
						if(!(text == this.t.t(com.wiris.quizzes.impl.Assertion.EQUIVALENT_SYMBOLIC))) {
							equivalent = text;
							if(!StringTools.endsWith(equivalent,".")) equivalent = equivalent + ".";
							showComparison = true;
						}
					} else {
	...
	,getAssertionString: function(a,chars) {
		var sb = new StringBuf();
		sb.b += Std.string(this.t.t(a.name));
		if(a.parameters != null && a.parameters.length > 0) {
			...
			while(_g1 < _g) {
				var i1 = _g1++;
				sb.b += Std.string(" ");
				sb.b += Std.string(a.parameters[i1].content);
			}
		}
		var res = sb.b;
		if(res.length > chars) res = HxOverrides.substr(res,0,chars - 3) + "...";
		return res;
	}
	...
	,printOutputControls: function(h,unique) {
		...
		h.label(this.t.t(com.wiris.quizzes.impl.Option.OPTION_PRECISION),id,"wirisleftlabel wirisleftlabellist");
	...
	,printInputControls: function(h,q,correctAnswer,unique) {
		...
		while(_g1 < _g) {
			var i1 = _g1++;
			if(com.wiris.quizzes.impl.Assertion.syntactic[i1] == com.wiris.quizzes.impl.Assertion.SYNTAX_LIST) continue;
			h.openLi();
		...
		this.syntaxCheckbox(h,id + "[3]","sr, m, g, s, E, K, mol, cd, rad, h, min, l, N, Pa, Hz, W,J, C, V, " + com.wiris.system.Utf8.uchr(937) + ", F, S, Wb, b, H, T, lx, lm, Gy, Bq, Sv, kat",this.t.t("all"),true);
		h.close();
		h.close();
		...
		h.close();
		h.close();
		h.openDivClass("wirissyntaxcurlybracket" + unique,"wirissyntaxparam");
		h.openSpan("wirissyntaxcurlybracketlabel" + unique,"wirissyntaxlabel");
		h.text(this.t.t("curlybrackets") + ":");
		h.close();
		h.openSpan("wirissyntaxcurlybracketvalues" + unique,"wirissyntaxvalues");
		id = "wirisassertionparampart" + unique + "[syntax_expression, syntax_quantity, syntax_list][listoperators][" + correctAnswer + "][0]";
		this.syntaxRadio(h,id + "[0]","wirissyntaxcurlybracket" + unique,"{",this.t.t("list"));
		this.syntaxRadio(h,id + "[1]","wirissyntaxcurlybracket" + unique,"",this.t.t("parenthesis"));
		h.close();
		h.close();
...
com.wiris.quizzes.impl.HTMLGuiConfig = $hxClasses["com.wiris.quizzes.impl.HTMLGuiConfig"] = function(classes) {
	...
	while(_g1 < _g) {
		...
		if(className == com.wiris.quizzes.impl.HTMLGuiConfig.WIRISMULTICHOICE) {
			this.multichoiceConfig();
			this.configClasses.push(com.wiris.quizzes.impl.HTMLGuiConfig.WIRISMULTICHOICE);
		} else if(className == com.wiris.quizzes.impl.HTMLGuiConfig.WIRISOPENANSWER) {
			this.openAnswerConfig();
			this.configClasses.push(com.wiris.quizzes.impl.HTMLGuiConfig.WIRISOPENANSWER);
		} else if(className == com.wiris.quizzes.impl.HTMLGuiConfig.WIRISESSAY) {
			this.essayConfig();
			this.configClasses.push(com.wiris.quizzes.impl.HTMLGuiConfig.WIRISESSAY);
		}
	}
	var _g1 = 0, _g = classArray.length;
	while(_g1 < _g) {
		var i1 = _g1++;
		var className = classArray[i1];
		if(className == com.wiris.quizzes.impl.HTMLGuiConfig.WIRISVARIABLES) {
			this.tabVariables = true;
			this.configClasses.push(com.wiris.quizzes.impl.HTMLGuiConfig.WIRISVARIABLES);
		} else if(className == com.wiris.quizzes.impl.HTMLGuiConfig.WIRISAUXILIARCAS) {
			this.optAuxiliarCas = true;
			this.tabCorrectAnswer = true;
			this.configClasses.push(com.wiris.quizzes.impl.HTMLGuiConfig.WIRISAUXILIARCAS);
		}
	}
};
...
com.wiris.quizzes.impl.HTMLGuiConfig.prototype = {
	getClasses: function() {
		...
		while(_g1 < _g) {
			...
			sb.b += Std.string(this.configClasses[i1]);
		}
		return sb.b;
	}
...
com.wiris.quizzes.impl.HTMLTools.prototype = {
	unitTestDev: function() {
		haxe.Log.trace("compare(a,a1)=" + com.wiris.quizzes.impl.HTMLTools.compareStrings("a","a1"),{ fileName : "HTMLTools.hx", lineNumber : 1455, className : "com.wiris.quizzes.impl.HTMLTools", methodName : "unitTestDev"});
		var a = new Array();
		a.push("a");
		a.push("a1");
		...
		haxe.Log.trace("sort({a1,a})" + r,{ fileName : "HTMLTools.hx", lineNumber : 1466, className : "com.wiris.quizzes.impl.HTMLTools", methodName : "unitTestDev"});
	}
	,unitTest: function() {
	...
	,unitTestTextToMathML: function() {
		...
		var responses = ["<math xmlns=\"http://www.w3.org/1998/Math/MathML\"><mi>sin</mi><mo>(</mo><mi>x</mi><mo>)</mo><mo>+</mo><mn>1</mn></math>","<math xmlns=\"http://www.w3.org/1998/Math/MathML\"><mo>#</mo><mi>F</mi><mo> </mo><mo>+</mo><mi>C</mi></math>","<math xmlns=\"http://www.w3.org/1998/Math/MathML\"><mn>2</mn><mo>.</mo><mn>0</mn><mo>·</mo><mi>x</mi><mi>y</mi></math>"];
		var i;
	...
	,mathMLToText: function(mathml) {
		...
		while((start = mathml.indexOf("<",start)) != -1) {
			...
			if(end == -1) break;
			var tag = HxOverrides.substr(mathml,start,end - start);
			var space;
			if((space = tag.indexOf(" ")) != -1) tag = HxOverrides.substr(tag,0,space);
			...
			if(mi && lastReserved || lastMi && reserved) text.b += Std.string(" ");
			text.b += Std.string(content);
			lastMi = mi;
	...
	,textToMathML: function(text) {
		...
		while(i < n) {
			...
			if(com.wiris.quizzes.impl.HTMLTools.isDigit(c)) {
				...
				if(c == 32) c = 160;
				mathml.b += Std.string(com.wiris.system.Utf8.uchr(c));
				mathml.b += Std.string("</mo>");
				i++;
				if(i < n) c = HxOverrides.cca(text,i);
			}
...
com.wiris.quizzes.impl.HttpImpl = $hxClasses["com.wiris.quizzes.impl.HttpImpl"] = function(url) {
...
com.wiris.quizzes.impl.MathMLFilter.prototype = {
	...
	,writeImage: function(mathml,s) {
		var h = new com.wiris.quizzes.impl.HttpImpl(com.wiris.quizzes.impl.QuizzesBuilderImpl.getInstance().getConfiguration().get(com.wiris.quizzes.api.ConfigurationKeys.EDITOR_URL) + "/render");
...
com.wiris.quizzes.impl.MaxConnectionsHttpImpl = $hxClasses["com.wiris.quizzes.impl.MaxConnectionsHttpImpl"] = function(url) {
	com.wiris.quizzes.impl.HttpImpl.call(this,url);
	try {
...
com.wiris.quizzes.impl.QuestionImpl.syntacticAssertionToURL = function(a) {
	var sb = new StringBuf();
	if(a.name == com.wiris.quizzes.impl.Assertion.SYNTAX_EXPRESSION) sb.b += Std.string("Expression"); else if(a.name == com.wiris.quizzes.impl.Assertion.SYNTAX_QUANTITY) sb.b += Std.string("Quantity"); else if(a.name == com.wiris.quizzes.impl.Assertion.SYNTAX_LIST) sb.b += Std.string("List");
	if(a.parameters != null && a.parameters.length > 0) {
		sb.b += Std.string("?");
		var i;
		var _g1 = 0, _g = a.parameters.length;
...
com.wiris.quizzes.impl.QuestionInstanceImpl.prototype = $extend(com.wiris.util.xml.SerializableImpl.prototype,{
	...
	,getBooleanVariableValue: function(name) {
		...
		if(mmlvars.exists(name)) {
			var mmlValue = textvars.get(name);
...
com.wiris.quizzes.impl.QuizzesBuilderImpl.main = function() {
}
...
com.wiris.quizzes.impl.QuizzesBuilderImpl.prototype = $extend(com.wiris.quizzes.api.QuizzesBuilder.prototype,{
	...
	,getSerializer: function() {
		if(this.serializer == null) {
			...
			this.serializer.register(new com.wiris.quizzes.impl.AssertionCheck());
	...
	,newEvalMultipleAnswersRequest: function(correctAnswers,userAnswers,question,instance) {
		...
		var pairs = this.getPairings(correctAnswers.length,userAnswers.length);
		...
		while(_g1 < _g) {
			...
			var foundEquiv = false;
			var k;
			var _g3 = 0, _g2 = qq.assertions.length;
			while(_g3 < _g2) {
				var k1 = _g3++;
				if(this.inArray(correct,qq.assertions[k1].getCorrectAnswers()) && this.inArray(user,qq.assertions[k1].getAnswers())) {
					foundSyntax = foundSyntax || qq.assertions[k1].isSyntactic();
					foundEquiv = foundEquiv || qq.assertions[k1].isEquivalence();
				}
			}
			if(!foundSyntax) qq.setAssertion(com.wiris.quizzes.impl.Assertion.SYNTAX_EXPRESSION,correct,user);
			if(!foundEquiv) qq.setAssertion(com.wiris.quizzes.impl.Assertion.EQUIVALENT_SYMBOLIC,correct,user);
		}
		...
		while(_g1 < _g) {
			...
			if(value == null) value = "";
			if(qi != null && qi.hasVariables()) value = qi.expandVariablesMathML(value);
...
com.wiris.quizzes.impl.QuizzesServiceImpl.prototype = {
	...
	,callQuizzesService: function(postData) {
		var http;
		if(com.wiris.settings.PlatformSettings.IS_JAVASCRIPT) {
			var url = com.wiris.quizzes.impl.QuizzesBuilderImpl.getInstance().getConfiguration().get(com.wiris.quizzes.api.ConfigurationKeys.PROXY_URL);
			http = new com.wiris.quizzes.impl.HttpImpl(url);
			...
			http = new com.wiris.quizzes.impl.MaxConnectionsHttpImpl(url);
			http.setHeader("Connection","close");
	...
	,executeMultiple: function(mqr) {
		...
		var response = this.callService(s,mqr,cache);
		...
		if(!cache && this.useCache) {
			...
			while(_g1 < _g) {
				var k1 = _g1++;
				var rsq = js.Boot.__cast(res.questionResponses[k1].results.pop() , com.wiris.quizzes.impl.ResultStoreQuestion);
				mqr.questionRequests[k1].question.setId(rsq.id);
			}
		}
		return res;
	}
	,callService: function(s,mqr,cache) {
		s.setCached(cache);
		if(!cache && this.useCache) {
			var j;
			...
			while(_g1 < _g) {
				var j1 = _g1++;
				mqr.questionRequests[j1].processes.push(new com.wiris.quizzes.impl.ProcessStoreQuestion());
			}
		}
		var postData = this.webServiceEnvelope(s.write(mqr));
		var response = this.callQuizzesService(postData);
		return response;
	}
...
com.wiris.quizzes.impl.ResultGetCheckAssertions.prototype = $extend(com.wiris.quizzes.impl.Result.prototype,{
	...
	,onSerialize: function(s) {
		...
		this.onSerializeInner(s);
		this.checks = s.serializeArray(this.checks,com.wiris.quizzes.impl.AssertionCheck.tagName);
		s.endTag();
	}
	,checks: null
...
if(!com.wiris.quizzes.wrap) com.wiris.quizzes.wrap = {}
com.wiris.quizzes.wrap.Wrapper = $hxClasses["com.wiris.quizzes.wrap.Wrapper"] = function() {
};
com.wiris.quizzes.wrap.Wrapper.__name__ = ["com","wiris","quizzes","wrap","Wrapper"];
com.wiris.quizzes.wrap.Wrapper.wrapper = null;
com.wiris.quizzes.wrap.Wrapper.getInstance = function() {
	if(com.wiris.quizzes.wrap.Wrapper.wrapper == null) com.wiris.quizzes.wrap.Wrapper.wrapper = new com.wiris.quizzes.wrap.Wrapper();
	return com.wiris.quizzes.wrap.Wrapper.wrapper;
}
com.wiris.quizzes.wrap.Wrapper.prototype = {
	stop: function() {
	...
	,isRunning: null
	,__class__: com.wiris.quizzes.wrap.Wrapper
}
...
com.wiris.system.Storage.newResourceStorage = function(name) {
	return new com.wiris.system.Storage(com.wiris.system.Storage.getResourcesDir() + com.wiris.system.Storage.getDirectorySeparator() + name);
}
...
com.wiris.system.Storage.prototype = {
	...
	,read: function() {
		var b = haxe.io.Bytes.ofData(this.readBinary());
		return b.toString();
	}
	,readBinary: function() {
		var res = null;
...
com.wiris.util.sys.IniFile.prototype = {
	loadProperties: function(file) {
		...
		while((start = file.indexOf("\n",end)) != -1) {
			...
			if(StringTools.startsWith(line,";") || StringTools.startsWith(line,"#")) continue;
	...
	,loadINI: function() {
		...
		if(s.exists()) file = s.read(); else {
			var r = com.wiris.system.Storage.newResourceStorage(this.filename);
			file = r.read();
		}
...
com.wiris.util.xml.XmlSerializer.prototype = {
	importXml: function(elem,model) {
		...
		if(elem.nodeType == Xml.Element) {
			...
			while(children.hasNext()) n.addChild(this.importXml(children.next(),model));
		} else if(elem.nodeType == Xml.Document) n = this.importXml(elem.firstElement(),model); else if(elem.nodeType == Xml.CData) n = Xml.createCData(elem.getNodeValue()); else if(elem.nodeType == Xml.PCData) n = Xml.createPCData(elem.getNodeValue()); else throw "Unsupported node type: " + Std.string(elem.nodeType);
		return n;
	}
	,serializeXml: function(tag,elem) {
		if(this.mode == com.wiris.util.xml.XmlSerializer.MODE_READ) {
			if(this.currentChild().getNodeName() == tag) elem = this.currentChild();
			this.nextChild();
		} else if(this.mode == com.wiris.util.xml.XmlSerializer.MODE_WRITE) {
			if(elem != null) {
				var imported = this.importXml(elem,this.element);
				this.element.addChild(imported);
			}
		} else if(this.mode == com.wiris.util.xml.XmlSerializer.MODE_REGISTER) this.beginTag(tag);
		return elem;
	}
	,serializeProperties: function(name,childName,keyAttribute,value,def) {
		if(this.mode == com.wiris.util.xml.XmlSerializer.MODE_WRITE) {
			if(value != null && !(!def.keys().hasNext() && !value.keys().hasNext())) {
				this.beginTag(name);
				var keys = value.keys();
				while(keys.hasNext()) {
					var key = keys.next();
					var val = value.get(key);
					var defval = def.get(key);
					if(!(val == defval)) {
						this.beginTag(childName);
						this.attributeString(keyAttribute,key,null);
		...
		} else if(this.mode == com.wiris.util.xml.XmlSerializer.MODE_READ) {
			value = new Hash();
			var keys = def.keys();
			while(keys.hasNext()) {
				var key = keys.next();
				value.set(key,def.get(key));
			}
			if(this.beginTag(name)) {
				while(this.beginTag(childName)) {
					value.set(this.attributeString(keyAttribute,null,null),this.textContent(null));
					this.endTag();
				}
				this.endTag();
			}
	...
	,readNode: function() {
		if(!this.tags.exists(this.currentChild().getNodeName())) throw "Tag " + this.element.getNodeName() + " not registered.";
	...
	,textContent: function(content) {
		if(this.mode == com.wiris.util.xml.XmlSerializer.MODE_READ) content = com.wiris.util.xml.XmlSerializer.getXmlTextContent(this.element); else if(this.mode == com.wiris.util.xml.XmlSerializer.MODE_WRITE && content != null) {
			var textNode;
	...
	,endTag: function() {
		if(this.mode == com.wiris.util.xml.XmlSerializer.MODE_READ) {
			...
			this.popState();
			this.nextChild();
		} else if(this.mode == com.wiris.util.xml.XmlSerializer.MODE_WRITE) this.element = this.element.getParent(); else if(this.mode == com.wiris.util.xml.XmlSerializer.MODE_CACHE) {
			if(this.cacheTagStackCount == 0) {
				this.mode = com.wiris.util.xml.XmlSerializer.MODE_WRITE;
				this.element = this.element.getParent();
			} else this.cacheTagStackCount--;
		}
	}
	...
	,write: function(s) {
		...
		while(_g1 < _g) {
			var i1 = _g1++;
			res = StringTools.replace(res,"<rawXml id=\"" + i1 + "\"/>",this.rawxmls[i1]);
		}
		return res;
	}
	,read: function(xml) {
...
com.wiris.quizzes.JsAuthoringInput.TYPE_EDITOR = 0;
com.wiris.quizzes.JsAuthoringInput.TYPE_STUDIO = 1;
...
com.wiris.quizzes.impl.Assertion.syntactic = [com.wiris.quizzes.impl.Assertion.SYNTAX_EXPRESSION,com.wiris.quizzes.impl.Assertion.SYNTAX_QUANTITY,com.wiris.quizzes.impl.Assertion.SYNTAX_LIST];
com.wiris.quizzes.impl.Assertion.equivalent = [com.wiris.quizzes.impl.Assertion.EQUIVALENT_SYMBOLIC,com.wiris.quizzes.impl.Assertion.EQUIVALENT_LITERAL,com.wiris.quizzes.impl.Assertion.EQUIVALENT_SET,com.wiris.quizzes.impl.Assertion.EQUIVALENT_FUNCTION];
...
com.wiris.quizzes.impl.AssertionCheck.tagName = "check";
