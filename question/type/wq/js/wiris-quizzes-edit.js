...
function openInitialCASContentPopup(){
  window.open(WirisQuizzes.constants.wwwroot + '/wiris-quizzes/lib/initialcascontent.php', 'initialcascontent', 'width=650,height=340');
}
...
function saveCASContent(){
    var session = document.getElementsByName("WirisCASApplet")[0].getXML();
    var cdata = '<![CDATA[' + session + ']]>';
    var wirisCasSession = '<wirisCasSession>' + cdata + '</wirisCasSession>';
    var question = '<question>' + wirisCasSession + '</question>';
    document.getElementsByName("hiddenCASValue")[0].value = question;
}