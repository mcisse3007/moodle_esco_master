...
<form>
    <table class="main">
        <tr><td colspan="2">Enregistrez votre voix à l'aide de cet outil.</td></tr>
        <tr>
            <td class="applet">
                <table>
                    <tr>
        ...
        <tr><td colspan="2" id="nanogong_message">Appuyez sur le bouton Insérer pour valider votre enregistrement.</td></tr>
    </table>
